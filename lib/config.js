 ...
 * @property {number} [lines] Number of display lines (1 or 2, default: 1)
 ...
 * @property {boolean} [showRateLimitCountdown] Show countdown until quota resets, e.g. 5h:28%(2h15m)
